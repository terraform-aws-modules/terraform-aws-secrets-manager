...
[compliance.tf](https://compliance.tf/docs/workarounds/terraform-aws-secrets-manager/?utm_source=github&utm_medium=readme&utm_campaign=known-limitations) serves this module with these rules applied at
...
https://registry.compliance.tf/playground?module=terraform-aws-modules/secrets-manager/aws&rules=lifecycle_prevent_destroy_encryption - no account needed.
