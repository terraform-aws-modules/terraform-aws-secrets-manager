module "wrapper" {
  ...
  random_password_min_lower        = try(each.value.random_password_min_lower, var.defaults.random_password_min_lower, 0)
  random_password_min_numeric      = try(each.value.random_password_min_numeric, var.defaults.random_password_min_numeric, 0)
  random_password_min_special      = try(each.value.random_password_min_special, var.defaults.random_password_min_special, 0)
  random_password_min_upper        = try(each.value.random_password_min_upper, var.defaults.random_password_min_upper, 0)
